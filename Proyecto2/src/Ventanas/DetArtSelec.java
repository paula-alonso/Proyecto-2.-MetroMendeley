...
public class DetArtSelec extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 250, 140, -1));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/fondo.png"))); // NOI18N
        jPanel1.add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 670, 300));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetArtSelec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetArtSelec().setVisible(true);
            }
        });
    }
